...
- **Aga Club (lekki panel)** — lista członków (ręczne dodawanie — nie ma jeszcze publicznej rejestracji) oraz moderacja czatu klubu. Edytor wyzwania „30 dni / 30 kroków” został usunięty 15.09.2026 razem z całym modułem (strona, link w menu klubu, definicja tabeli w `db/postgres/schema.sql`).
