...
export const MALOPOLSKA_AGI: Location[] = [
  miastoAgi({ name: "Bochnia", slug: "bochnia", population: 29_000, neighborSlugs: ["brzesko", "nowy-wisnicz", "gdow"] }),
  miastoAgi({ name: "Brzesko", slug: "brzesko", population: 16_500, neighborSlugs: ["bochnia", "wojnicz", "zakliczyn"] }),
  ...
  miastoAgi({ name: "Wieliczka", slug: "wieliczka", population: 24_000, neighborSlugs: ["niepolomice", "gdow", "swiatniki-gorne"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Niepołomice", slug: "niepolomice", population: 13_000, neighborSlugs: ["wieliczka", "bochnia"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Nowy Wiśnicz", slug: "nowy-wisnicz", population: 2_700, neighborSlugs: ["bochnia"], largerCitySlug: "bochnia" }),
  miastoAgi({ name: "Tarnów", slug: "tarnow", population: 105_000, neighborSlugs: ["wojnicz", "zakliczyn", "brzesko"] }),
  miastoAgi({ name: "Dobczyce", slug: "dobczyce", population: 6_500, neighborSlugs: ["myslenice", "gdow"] }),
  miastoAgi({ name: "Limanowa", slug: "limanowa", population: 15_000, neighborSlugs: ["nowy-sacz", "myslenice"] }),
  miastoAgi({ name: "Myślenice", slug: "myslenice", population: 18_000, neighborSlugs: ["dobczyce", "skawina"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Nowy Sącz", slug: "nowy-sacz", population: 82_000, neighborSlugs: ["limanowa"] }),
  miastoAgi({ name: "Gdów", slug: "gdow", population: 2_400, neighborSlugs: ["bochnia", "dobczyce"] }),
  miastoAgi({ name: "Zakliczyn", slug: "zakliczyn", population: 1_600, neighborSlugs: ["brzesko", "tarnow"] }),
  miastoAgi({ name: "Wojnicz", slug: "wojnicz", population: 3_500, neighborSlugs: ["tarnow", "brzesko"] }),
  miastoAgi({ name: "Skawina", slug: "skawina", population: 24_000, neighborSlugs: ["myslenice"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Proszowice", slug: "proszowice", population: 6_000, neighborSlugs: ["niepolomice"], largerCitySlug: "krakow" }),
  ...
  miastoAgi({ name: "Chrzanów", slug: "chrzanow", population: 34_000, neighborSlugs: ["skawina"], largerCitySlug: "krakow" }),
  ...
  miastoAgi({ name: "Zielonki", slug: "zielonki", population: 25_000, neighborSlugs: ["michalowice"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Michałowice", slug: "michalowice", population: 13_500, neighborSlugs: ["zielonki"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Zabierzów", slug: "zabierzow", population: 29_700, neighborSlugs: ["krzeszowice"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Krzeszowice", slug: "krzeszowice", population: 31_800, neighborSlugs: ["zabierzow", "chrzanow"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Mogilany", slug: "mogilany", population: 16_400, neighborSlugs: ["swiatniki-gorne", "skawina"], largerCitySlug: "krakow" }),
  miastoAgi({ name: "Świątniki Górne", slug: "swiatniki-gorne", population: 11_200, neighborSlugs: ["mogilany", "wieliczka"], largerCitySlug: "krakow" }),
  ...
  miastoAgi({ name: "Rzezawa", slug: "rzezawa", population: 11_500, neighborSlugs: ["bochnia", "brzesko", "drwinia"], largerCitySlug: "bochnia" }),
  miastoAgi({ name: "Drwinia", slug: "drwinia", population: 6_400, neighborSlugs: ["bochnia", "niepolomice", "rzezawa"], largerCitySlug: "bochnia" }),
  miastoAgi({ name: "Łapanów", slug: "lapanow", population: 8_600, neighborSlugs: ["gdow", "trzciana", "zegocina"], largerCitySlug: "bochnia" }),
  miastoAgi({ name: "Trzciana", slug: "trzciana", population: 5_700, neighborSlugs: ["lapanow", "zegocina", "nowy-wisnicz"], largerCitySlug: "bochnia" }),
  miastoAgi({ name: "Żegocina", slug: "zegocina", population: 5_500, neighborSlugs: ["trzciana", "lapanow", "lipnica-murowana"], largerCitySlug: "bochnia" }),
  miastoAgi({ name: "Lipnica Murowana", slug: "lipnica-murowana", population: 5_500, neighborSlugs: ["nowy-wisnicz", "zegocina", "brzesko"], largerCitySlug: "bochnia" }),
];
