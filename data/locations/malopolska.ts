...
export const MALOPOLSKA_AGI: Location[] = [
  ...
  miastoAgi({
    ...
    slug: "oswiecim-gmina",
    population: 18_971,
    neighborSlugs: ["kety", "brzeszcze", "chelmek", "osiek", "polanka-wielka", "przeciszow"],
    largerCitySlug: "oswiecim",
  }),
  miastoAgi({
    name: "Kęty",
    slug: "kety",
    population: 33_240,
    neighborSlugs: ["oswiecim-gmina", "brzeszcze", "osiek", "wieprz", "andrychow"],
    largerCitySlug: "oswiecim",
  }),
  miastoAgi({
    name: "Brzeszcze",
    slug: "brzeszcze",
    population: 20_306,
    neighborSlugs: ["oswiecim-gmina", "kety", "chelmek"],
    largerCitySlug: "oswiecim",
  }),
  miastoAgi({
    name: "Zator",
    slug: "zator",
    population: 9_082,
    neighborSlugs: ["przeciszow", "spytkowice", "brzeznica", "polanka-wielka", "osiek", "tomice"],
    largerCitySlug: "oswiecim",
  }),
  miastoAgi({
    name: "Osiek",
    slug: "osiek",
    population: 8_112,
    neighborSlugs: ["przeciszow", "kety", "polanka-wielka", "wieprz", "oswiecim-gmina"],
    largerCitySlug: "oswiecim",
  }),
  miastoAgi({
    name: "Polanka Wielka",
    slug: "polanka-wielka",
    population: 4_300,
    neighborSlugs: ["osiek", "przeciszow", "oswiecim-gmina", "zator"],
    largerCitySlug: "oswiecim",
  }),
  miastoAgi({
    name: "Przeciszów",
    slug: "przeciszow",
    population: 6_328,
    neighborSlugs: ["zator", "osiek", "polanka-wielka", "oswiecim-gmina", "spytkowice"],
    largerCitySlug: "oswiecim",
  }),
  miastoAgi({
    name: "Koniusza",
    slug: "koniusza",
    population: 9_078,
    neighborSlugs: ["proszowice", "slomniki", "kocmyrzow-luborzyca", "igolomia-wawrzenczyce", "palecznica"],
    largerCitySlug: "krakow",
  }),
  miastoAgi({
    name: "Gmina Limanowa",
    slug: "limanowa-gmina",
    population: 26_118,
    neighborSlugs: ["limanowa", "tymbark", "slopnice", "laskowa", "jodlownik", "lukowica"],
    largerCitySlug: "limanowa",
  }),
  miastoAgi({
    name: "Gmina Mszana Dolna",
    slug: "mszana-dolna-gmina",
    population: 17_652,
    neighborSlugs: ["mszana-dolna", "dobra", "kamienica", "niedzwiedz", "rabka-zdroj", "lubien", "pcim", "wisniowa"],
    largerCitySlug: "mszana-dolna",
  }),
  miastoAgi({
    name: "Szczawa",
    slug: "szczawa",
    population: 1_830,
    neighborSlugs: ["kamienica", "mszana-dolna-gmina", "niedzwiedz", "ochotnica-dolna", "slopnice"],
    largerCitySlug: "mszana-dolna",
  }),
  miastoAgi({
    name: "Gmina Bochnia",
    slug: "bochnia-gmina",
    population: 20_857,
    neighborSlugs: ["bochnia", "rzezawa", "lapanow", "klaj", "gdow", "nowy-wisnicz", "trzciana", "drwinia"],
    largerCitySlug: "bochnia",
  }),
  miastoAgi({
    name: "Radgoszcz",
