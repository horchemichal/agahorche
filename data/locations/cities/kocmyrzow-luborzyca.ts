...
export const KOCMYRZOW_LUBORZYCA: CityContent = {
  ...
  seoDescription:
    "Thermomix w gminie Kocmyrzów-Luborzyca: bezpłatna prezentacja TM7 u Ciebie w kuchni, cena i raty 0%. Dojazd do wszystkich dwudziestu pięciu sołectw bez dopłat. Aga, tel. 517 185 691.",
