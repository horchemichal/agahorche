...
export const RZEPIENNIK_STRZYZEWSKI: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Jest tu jeszcze jeden zaskakujący szczegół. Siedziba gminy nie jest jej największą miejscowością. Najwięcej ludzi mieszka w Olszynach — ponad dwa tysiące. Drugi jest Rzepiennik Biskupi, blisko tysiąc czterysta osób, a dopiero potem Strzyżewski. To Biskupi ma za to najstarszy zabytek gminy: drewniany, gotycki kościół świętego Jana Chrzciciela z szesnastego wieku, z bali modrzewiowych i sosnowych. I to tamtejsza parafia przez pięć wieków obejmowała sześć wsi rozrzuconych na dwudziestu kilometrach; pierwszy podział nastąpił dopiero w tysiąc osiemset czterdziestym.",
  ...
  districtsParagraphs: [
    ...
    "W Rzepienniku Biskupim stoi drewniany, gotycki kościół świętego Jana Chrzciciela z szesnastego wieku, zbudowany z bali modrzewiowych i sosnowych. Drugi drewniany kościół, z tysiąc dziewięćsetnego roku, jest w Olszynach.",
