...
export const RZEPIENNIK_STRZYZEWSKI: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Jest tu jeszcze jeden zaskakujący szczegół. Siedziba gminy nie jest jej największą miejscowością. Najwięcej ludzi mieszka w Olszynach — ponad dwa tysiące. Drugi jest Rzepiennik Biskupi, blisko tysiąc czterysta osób, a dopiero potem Strzyżewski. To Biskupi ma za to najstarszy zabytek gminy: drewniany, gotycki kościół świętego Jana Chrzciciela, postawiony na początku szesnastego wieku, z bali modrzewiowych i sosnowych. I to tamtejsza parafia przez pięć wieków obejmowała sześć wsi rozrzuconych na dwudziestu kilometrach; pierwszy podział nastąpił dopiero w tysiąc osiemset czterdziestym.",
  ...
  culinary: {
    ...
    paragraphs: [
      ...
      "Osobno warto wiedzieć o drewnie: w gminie działa firma meblarska w Rzepienniku Biskupim, a produkcja wyrobów drewnianych jest tu jedną z wiodących branż. Drewniane są też dwa tutejsze kościoły — ten z Rzepiennika Biskupiego ma ponad pięćset lat.",
  ...
  districtsParagraphs: [
    ...
    "Sołectwa to: Rzepiennik Strzyżewski, Rzepiennik Biskupi, Rzepiennik Suchy, Olszyny, Kołkówka i Turza. Największą wsią nie jest siedziba gminy, tylko Olszyny — ponad dwa tysiące mieszkańców. Drugi jest Rzepiennik Biskupi, blisko tysiąc czterysta osób.",
    ...
    "W Rzepienniku Biskupim stoi drewniany, gotycki kościół świętego Jana Chrzciciela z początku szesnastego wieku, zbudowany z bali modrzewiowych i sosnowych. Drugi drewniany kościół, z tysiąc dziewięćsetnego roku, jest w Olszynach.",
