...
export const SLABOSZOW: CityContent = {
  ...
  districtsParagraphs: [
    ...
    "O dojeździe uczciwie: w gminie Słaboszów nie ma kolei. Najbliższa stacja to Miechów, skąd Koleje Małopolskie dowożą do Krakowa. W sąsiedztwie przebiega droga wojewódzka numer siedemset osiemdziesiąt trzy. Ciekawostka historyczna: przez gminę biegła kiedyś kolejka wąskotorowa z Charsznicy przez Miechów do Działoszyc, otwarta przez Austriaków w tysiąc dziewięćset szesnastym roku. Pociągi pasażerskie przestały nią jeździć w tysiąc dziewięćset osiemdziesiątym trzecim, a tory rozebrano w tysiąc dziewięćset dziewięćdziesiątym drugim.",
  ],
  districts: [
    "Kalina Wielka",
    "Słupów",
