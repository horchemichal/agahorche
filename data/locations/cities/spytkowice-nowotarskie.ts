...
export const SPYTKOWICE_NOWOTARSKIE: CityContent = {
  ...
  culinary: {
    ...
    paragraphs: [
      "W tysiąc dziewięćset dwudziestym szóstym roku powstało tu Katolickie Stowarzyszenie Młodzieży Żeńskiej, a dziś działa koło gospodyń wiejskich. Prowadzono w nim kursy haftu, szycia, pieczenia i gotowania — czyli dokładnie to, co dziś nazwalibyśmy edukacją kulinarną, tylko sto lat temu.",
