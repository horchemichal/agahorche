...
export const ROPA: CityContent = {
  ...
  districtsParagraphs: [
    ...
    "W samej Ropie stoi dwór z przełomu szesnastego i siedemnastego wieku, przebudowany w tysiąc osiemset trzecim w stylu barokowo-klasycystycznym, oraz drewniany kościół z tysiąc siedemset sześćdziesiątego pierwszego, ufundowany przez Wilhelma Siemieńskiego.",
