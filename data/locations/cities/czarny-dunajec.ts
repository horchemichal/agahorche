...
export const CZARNY_DUNAJEC: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Pierwszego stycznia dwa tysiące dwudziestego trzeciego roku Czarny Dunajec znów stał się miastem. Nie po raz pierwszy — prawa miejskie miał już w latach dwudziestych i trzydziestych dwudziestego wieku, a stracił je w tysiąc dziewięćset trzydziestym czwartym, na mocy reformy samorządowej z roku poprzedniego. Przerwa trwała osiemdziesiąt dziewięć lat.",
