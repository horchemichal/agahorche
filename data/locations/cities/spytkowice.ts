  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Krajobraz jest temu podporządkowany. Kompleks Stawy Spytkowice to woda ciągnąca się przez znaczną część gminy — stawy mają tu własne nazwy: Orłownik, Kempnik, Bagiennik, Jakubowiec, Grabnik. Stawy i dolina Skawy należą tu do obszaru Natura 2000 „Dolina Dolnej Skawy”, chroniącego ptaki: bąka, bączka, rybitwę białowąsą, błotniaka stawowego. Gmina od północy kończy się na Wiśle.",
        ...
        "Praktycznie znaczy to, że do bardzo wielu domów w tej gminie da się dojechać pociągiem i wielu ludzi tak właśnie jeździ do pracy. Wieczór po takim dniu wygląda zwykle podobnie: trzeba coś zjeść, a nie ma już siły stać przy garnku. I właśnie to pokazuję na spotkaniu — nie wymyślne danie, tylko obiad, który dochodzi sam, gdy Ty jesteś jeszcze w drodze.",
        "Powiem też wprost, gdzie jest granica: wprawy żadne urządzenie nie zastąpi. W gminie, w której działa pięć kół gospodyń, tej wprawy akurat nie brakuje. Zabiera stanie obok garnka i te czynności, przez które gotowanie od zera odkłada się na „kiedy indziej”.",
      ],
    },
    {
      id: "jak-umowic",
