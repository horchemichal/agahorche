  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Dzień Pstrąga odbywa się w amfiteatrze imienia Władysława Trebuni-Tutki. I tu rzecz, która mnie w tym najbardziej cieszy: obok zawodów wędkarskich rozgrywany jest konkurs kulinarny. W ostatniej edycji w kategorii „pstrąg tuczony” wygrało koło gospodyń z Gliczarowa Górnego, drugie było Nowe Bystre, trzecie Sierockie. W tej samej edycji najdłuższy złowiony pstrąg mierzył czterdzieści sześć i dwie dziesiąte centymetra.",
