...
export const SEKOWA: CityContent = {
  ...
  districtsParagraphs: [
    ...
    "Wapienne to niewielkie uzdrowisko z dwoma ujęciami wód, nazwanymi Marta i Kamila; wieś założono w tysiąc pięćset czterdziestym szóstym roku, a tutejsze wody uznawano za lecznicze już w siedemnastym wieku. W tysiąc osiemset dwunastym działał tu zakład kąpielowy, do którego trafiali żołnierze Napoleona. Bywa nazywane najmniejszym uzdrowiskiem w Polsce, ale tego akurat nie zweryfikowałam.",
