  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "I teraz liczba, która robi wrażenie: przez około sześćset siedemdziesiąt lat, do kasaty w tysiąc osiemset dziewiętnastym roku, ten klasztor władał dwiema trzecimi obszaru dzisiejszej gminy. Nie fragmentem — dwiema trzecimi.",
        "Po kasacie, od tysiąc osiemset trzydziestego drugiego roku, kościół pełni funkcję parafialnego, a od tysiąc dziewięćset czterdziestego dziewiątego prowadzą go pijarzy — czyli już nie norbertanie. Obecny kościół pochodzi z siedemnastego i osiemnastego wieku, pod nim są krypty z pochówkami opatów, a jego gotycki rdzeń jest jeszcze trzynastowieczny. Kościół razem z klasztorem, wzniesionym w latach tysiąc sześćset czterdzieści cztery–sześćdziesiąt cztery, wpisano do rejestru zabytków dwunastego stycznia tysiąc dziewięćset siedemdziesiątego drugiego roku, a klasztorny spichlerz z połowy osiemnastego wieku dopisano osobno, w tysiąc dziewięćset dziewięćdziesiątym piątym.",
