...
export const SZCZUROWA: CityContent = {
  ...
  culinary: {
    ...
    paragraphs: [
      ...
      "Drugim takim miejscem jest dwór w Dołędze — dziewiętnastowieczny zespół dworski z parkiem, spichlerzem i chałupą, od lat osiemdziesiątych oddział muzeum, z ekspozycją pokazującą, jak wyglądała wieś około tysiąc dziewięćsetnego roku. To jest, jeśli chcecie, tutejszy odpowiednik książki kucharskiej: nie przepis, tylko obraz domu, w którym się gotowało.",
