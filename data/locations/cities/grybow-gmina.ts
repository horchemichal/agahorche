...
export const GRYBOW_GMINA: CityContent = {
  ...
  culinary: {
    ...
    paragraphs: [
      ...
      "Obok firmy działa od dwa tysiące roku muzeum pszczelarstwa z ponad setką uli: kłodami bartnymi, ulami figuralnymi, koszkami słomianymi. Jedna z najstarszych kłód pochodzi z tysiąc osiemset dwudziestego drugiego roku i nazywa się „Król”. W pierwszą niedzielę lipca odbywa się tu Biesiada u Bartnika — z wykładami, miodobraniem, degustacją i kuchnią regionalną.",
  ...
  districtsParagraphs: [
    ...
    "Teren to Góry Grybowskie w Beskidzie Niskim; najwyższy szczyt, Jaworze, ma osiemset osiemdziesiąt dwa metry. Na Szlaku Architektury Drewnianej stoi tu aż sześć obiektów: kościół Wszystkich Świętych w Ptaszkowej z tysiąc pięćset pięćdziesiątego piątego roku, kościół świętego Andrzeja w Polnej z szesnastego wieku, kościół Narodzenia Najświętszej Maryi Panny w Krużlowej, kościół świętego Wojciecha w Kąclowej, dawna cerkiew świętego Dymitra w Binczarowej i skansen pszczelarski w Stróżach.",
