  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "W opisie ministerialnym z dwa tysiące szóstego roku podano areał upraw na dwa do dwóch i pół tysiąca hektarów. Muszę jednak dodać rzecz, którą wolę powiedzieć niż przemilczeć: w zestawieniach z ostatnich lat Charsznica przestała być największym producentem kapusty w Polsce. Nie dlatego, że sadzi się tu mniej — po prostu sąsiednie gminy, Koniusza i Igołomia-Wawrzeńczyce, rozkręciły uprawę na tyle, że mają dziś więcej hektarów. Tytuł „kapuściana stolica” jest nieformalny i dziś opisuje raczej tradycję niż ranking.",
