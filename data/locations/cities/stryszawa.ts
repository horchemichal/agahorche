...
export const STRYSZAWA: CityContent = {
  ...
  districtsParagraphs: [
    ...
    "O dojeździe koleją muszę powiedzieć wprost, jak jest dziś. Przez gminę biegnie linia numer dziewięćdziesiąt siedem ze Skawiny do Żywca, a przystanków i stacji jest tu pięć: Stryszawa, Lachowice, Lachowice Centrum, Kurów Suski i Hucisko. Stację w Lachowicach otwarto w tysiąc osiemset osiemdziesiątym czwartym roku. Linia jest jednak w modernizacji za ponad trzysta sześćdziesiąt milionów złotych i w czasie prac kursuje komunikacja zastępcza. Powrót pociągów zapowiadano na wrzesień dwa tysiące dwudziestego szóstego roku — sprawdź aktualny rozkład, zanim zaplanujesz podróż.",
