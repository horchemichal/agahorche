...
export const GORLICE_GMINA: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Obok, w tym samym Szymbarku, działa od tysiąc dziewięćset osiemdziesiątego siódmego roku Skansen Wsi Pogórzańskiej imienia profesora Romana Reinfussa — niecałe dwa i pół hektara z kuźnią, młynami, olejarnią i piecem garncarskim. Pomysł powstał w sześćdziesiątym drugim, pierwsze budynki przeniesiono w siedemdziesiątym czwartym.",
  ...
  districtsParagraphs: [
    ...
    "Sołectwa to: Bielanka, Bystra, Dominikowice, Klęczany, Kobylanka, Kwiatonowice, Ropica Polska, Stróżówka, Szymbark i Zagórzany. Największy jest Szymbark z ponad trzema tysiącami mieszkańców, najmniejsza Bielanka z około stu osiemdziesięcioma.",
