...
export const LISZKI: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Sołectwo Piekary nazywa się tak, bo mieszkali w nim piekarze. Nie jest to domysł: pierwsza wzmianka pochodzi z tysiąc dwieście osiemdziesiątego szóstego roku, z dokumentu Leszka Czarnego zezwalającego benedyktynom z Tyńca lokować wsie na prawie niemieckim. Opactwo leży naprzeciwko, po drugiej stronie Wisły.",
