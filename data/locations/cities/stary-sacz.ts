...
export const STARY_SACZ: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Dziesiątego grudnia dwa tysiące osiemnastego roku Prezydent Rzeczypospolitej wydał rozporządzenie uznające starosądecki zespół staromiejski wraz z klasztorem sióstr klarysek za Pomnik Historii. To najwyższe wyróżnienie, jakie w Polsce może dostać zabytek — ma je dziś sto trzydzieści kilka miejsc w całym kraju.",
        ...
        "Klasztor stoi tu nieprzerwanie od tysiąc dwieście osiemdziesiątego roku, kiedy ufundowała go Kinga — ta sama, która dwadzieścia trzy lata wcześniej dostała ziemię sądecką od Bolesława Wstydliwego. Miasto lokowała jeszcze ona sama, w trzynastym wieku, a prawo magdeburskie nadała mu w tysiąc trzysta pięćdziesiątym siódmym ksieni Konstancja; rok później przywilej potwierdził Kazimierz Wielki.",
