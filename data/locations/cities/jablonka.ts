...
export const JABLONKA: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Jabłonkę nazywa się stolicą polskiej Orawy. Dodam uczciwie, że to określenie zwyczajowe, a nie żaden tytuł administracyjny — Jabłonka nie ma nawet praw miejskich, jest wsią i siedzibą gminy wiejskiej. Ale to największa miejscowość polskiej Orawy, z blisko pięcioma i pół tysiąca mieszkańców, i faktycznie zbiega się tu wszystko, co orawskie.",
        "Sama gmina należy do największych obszarowo w powiecie — dwieście trzynaście kilometrów kwadratowych, siedem sołectw. Przechodzi tędy droga krajowa numer siedem z przejściem granicznym Chyżne–Trstená, czyli główny korytarz drogowy między Polską a Słowacją.",
  ...
  districtsParagraphs: [
    ...
    "Sama Jabłonka liczy blisko pięć i pół tysiąca mieszkańców i jest największą miejscowością polskiej Orawy, choć praw miejskich nie ma. Cała gmina zajmuje dwieście trzynaście kilometrów kwadratowych — drugie miejsce w powiecie nowotarskim, po Czarnym Dunajcu.",
