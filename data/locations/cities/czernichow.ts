...
export const CZERNICHOW: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "W tysiąc osiemset sześćdziesiątym roku otwarto w Czernichowie szkołę rolniczą. Decyzja o jej powołaniu zapadła czternaście lat wcześniej, w tysiąc osiemset czterdziestym szóstym, na posiedzeniu Krakowskiego Towarzystwa Gospodarczo-Rolniczego. Szkoła działa do dziś i jest — cytując inwentarz Archiwum Polskiej Akademii Nauk — najstarszą szkołą rolniczą w Polsce.",
