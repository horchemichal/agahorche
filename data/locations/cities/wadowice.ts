...
export const WADOWICE: CityContent = {
  ...
  districtsParagraphs: [
    ...
    "Największa jest Chocznia — ponad pięć i pół tysiąca mieszkańców, ciągnąca się długim pasmem wzdłuż drogi. Dalej Klecza Dolna i Klecza Górna, Wysoka, Barwałd Dolny, Babica, Gorzeń Dolny i Gorzeń Górny, Jaroszowice, Kaczyna, Ponikiew, Roków, Stanisław Górny i Zawadka.",
