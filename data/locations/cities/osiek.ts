...
export const OSIEK: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "W Głębowicach jest z kolei drewniany kościół Matki Bożej Szkaplerznej: nawa z tysiąc pięćset osiemnastego roku, murowana zakrystia z siedemnastego wieku, a pierwszą kaplicę wzmiankowano tu już w tysiąc trzysta dwudziestym szóstym — czyli starszy niż cokolwiek w samej siedzibie gminy.",
      ],
    },
    {
      id: "jak-umowic",
  ...
  districtsParagraphs: [
    ...
    "W Osieku jest też drewniany, późnogotycki kościół świętego Andrzeja Apostoła — jeden z najcenniejszych drewnianych zabytków sakralnych pogranicza śląsko-małopolskiego. W Głębowicach drewniany kościół Matki Bożej Szkaplerznej — nawa z tysiąc pięćset osiemnastego roku, murowana zakrystia z siedemnastego wieku, a pierwsza wzmianka o tutejszej kaplicy z tysiąc trzysta dwudziestego szóstego.",
