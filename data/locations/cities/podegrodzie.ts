  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "I jeszcze jedna warstwa, ta najżywsza. Podegrodzie uchodzi za kolebkę Lachów Sądeckich, a tutejszy zespół regionalny działa od tysiąc dziewięćset trzydziestego siódmego roku, z przerwą na czas wojny — próby wznowiono w czterdziestym szóstym. Ma na koncie cztery Złote Ciupagi z Zakopanego i Nagrodę imienia Oskara Kolberga. W Muzeum Lachów Sądeckich imienia Zofii i Stanisława Chrząstowskich można zobaczyć stroje z przełomu wieków i fotografie Wojciecha Migacza — wiejskiego fotografa, który dokumentował tę okolicę od końca dziewiętnastego wieku.",
      ],
    },
    {
      id: "jak-umowic",
