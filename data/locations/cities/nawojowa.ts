...
export const NAWOJOWA: CityContent = {
  ...
  seoDescription:
    "Thermomix w gminie Nawojowa: bezpłatna prezentacja TM7 u Ciebie w kuchni, cena i raty 0%. Dojazd do wszystkich sołectw bez dopłat. Aga, tel. 517 185 691.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "W Nawojowej stoi zespół pałacowo-parkowy, a wokół niego jest coś, czego zwykle po dworach nie zostaje: ciągłość zawodowa. Po nacjonalizacji w tysiąc dziewięćset czterdziestym piątym urządzono tu najpierw ośrodek szkolenia leśników, a niedługo potem technikum rolnicze o specjalności hodowlanej. Szkolnictwo rolnicze zostało w Nawojowej do dziś, jako powiatowy zespół szkół imienia Wincentego Witosa — choć sam pałac wrócił w dwa tysiące czternastym roku do spadkobierców Stadnickich.",
  ...
  culinary: {
    ...
    paragraphs: [
      ...
      "To, co jest tu prawdziwe i trwałe, to szkolnictwo rolnicze. Po wojnie w pałacu ulokowano technikum hodowlane, a kształcenie zawodowe w tej dziedzinie działa w Nawojowej do dziś — już poza pałacem, bo ten wrócił do dawnych właścicieli. To gmina, w której od pokoleń uczy się, jak się hoduje, uprawia i przetwarza — a to jest przecież początek każdej kuchni.",
