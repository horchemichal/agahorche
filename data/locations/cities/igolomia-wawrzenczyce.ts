  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Jest jeszcze druga rzecz, która organizuje tu życie, i nie jest równie miła. Wisła płynie wzdłuż tej gminy długim odcinkiem i wyznacza jej południową granicę. Rowów melioracyjnych jest ponad sześćdziesiąt kilometrów, przy wałach stoją trzy przepompownie. W dwa tysiące dziesiątym roku woda przyszła cztery razy; najbardziej ucierpiały Tropiszów, Wawrzeńczyce i Wygnanów, a na niżej położonych polach przepadło osiemdziesiąt do dziewięćdziesięciu procent zbiorów.",
