  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Sam dwór postawiono pod koniec szesnastego wieku jako budowlę obronną, a w tysiąc siedemset czterdziestym pierwszym roku przebudowano na barokową rezydencję. Od tysiąc dziewięćset sześćdziesiątego dziewiątego roku jest oddziałem Zamku Królewskiego na Wawelu. Obok stoi dziewiętnastowieczny spichlerz, też objęty ochroną. Wtorki są dniem bezpłatnym, poniedziałki są nieczynne; godziny i ceny warto sprawdzić przed wyjazdem, bo bywają zmieniane.",
