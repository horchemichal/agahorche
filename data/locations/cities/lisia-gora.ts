...
export const LISIA_GORA: CityContent = {
  ...
  districtsParagraphs: [
    ...
    "W Lisiej Górze stoi barokowy kościół budowany w latach tysiąc siedemset szesnastego–dwudziestego ósmego, w miejscu wcześniejszego drewnianego, który spłonął w tysiąc siedemset dziesiątym roku. W gminie jest też cmentarz wojenny z pierwszej wojny, z czterdziestoma sześcioma pochowanymi.",
