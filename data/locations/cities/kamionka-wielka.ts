...
export const KAMIONKA_WIELKA: CityContent = {
  ...
  seoTitle: "Przedstawiciel Thermomix Kamionka Wielka — cena i prezentacja",
  seoDescription:
    "Thermomix w gminie Kamionka Wielka: bezpłatna prezentacja TM7 u Ciebie w kuchni, cena i raty 0%. Dojazd do wszystkich sołectw bez dopłat. Aga, tel. 517 185 691.",
