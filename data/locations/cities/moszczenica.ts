  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Kościołów było tu potem cztery, jeden po drugim: pierwszy drewniany po lokacji, drugi konsekrowany w tysiąc sześćset sześćdziesiątym szóstym, trzeci w tysiąc osiemset pięćdziesiątym, a obecny poświęcono w tysiąc dziewięćset dziewięćdziesiątym szóstym. Sześć i pół wieku ciągłości w jednym miejscu.",
