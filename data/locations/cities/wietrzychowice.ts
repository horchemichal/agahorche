  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Po pierwszym rozbiorze Wisła stała się granicą między zaborem austriackim a rosyjskim — i do dziś jest granicą województwa. Od tysiąc osiemset osiemdziesiątego trzeciego powstawały tu kółka rolnicze, w tysiąc dziewięćset dwunastym Komitet Parafialny Polskiego Stronnictwa Ludowego. W dwa tysiące dziesiątym roku gminę zalała wielka woda — w Woli Rogowskiej przeszła czterometrowa fala po przerwaniu wału Uszwicy oddalonej o dziesięć kilometrów. Zalane zostało wtedy niemal pięćdziesiąt kilometrów kwadratowych, czyli praktycznie cała gmina.",
