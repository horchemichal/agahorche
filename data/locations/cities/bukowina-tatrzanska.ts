...
export const BUKOWINA_TATRZANSKA: CityContent = {
  ...
  culinary: {
    ...
    paragraphs: [
      ...
      "Za to jest tu Szkoła Ginących Zawodów, działająca przy Domu Ludowym od tysiąc dziewięćset dziewięćdziesiątego dziewiątego roku, oraz sześć kół gospodyń — w Bukowinie, Brzegach, Czarnej Górze, na Rzepiskach, w Groniu i Jurgowie. To jest infrastruktura przekazywania umiejętności, a nie folder.",
