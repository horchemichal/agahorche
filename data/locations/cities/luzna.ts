  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "I druga rzecz, przez którą ta gmina ma komplet: w Szalowej stoi kościół świętego Michała Archanioła, który w dwa tysiące siedemnastym roku uznano za Pomnik Historii — czyli objęto najwyższą krajową formą ochrony zabytków. Budowany w latach tysiąc siedemset trzydziestym dziewiątym–pięćdziesiątym szóstym, drewniany, ale postawiony jak murowana bazylika barokowa: trójnawowy, z iluzjonistyczną polichromią. Konserwatorzy nazywają go jednym z najcenniejszych obiektów tego typu w skali europejskiej.",
