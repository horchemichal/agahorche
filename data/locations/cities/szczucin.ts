...
export const SZCZUCIN: CityContent = {
  ...
  seoDescription:
    "Thermomix w gminie Szczucin: bezpłatna prezentacja TM7 u Ciebie w kuchni, cena i raty 0%. Dojazd do miasta i wszystkich wsi bez dopłat. Aga, tel. 517 185 691.",
  ...
  sections: [
    ...
    sekcjaRaty(),
    {
      ...
      paragraphs: [
        ...
        "Reszta życia toczy się tu normalnie i to też trzeba powiedzieć. Działa zakład rezystorów uruchomiony jeszcze w tysiąc dziewięćset siedemdziesiątym, kilka firm budowlanych i usługowych, a przez miasto przechodzi ruch tranzytowy. Praca bywa zmianowa, dzień kończy się o różnych porach.",
  ...
  districtsParagraphs: [
    ...
    "Dojazd: przez Szczucin biegnie droga krajowa z Warszawy do Jasła, a most stalowy na Wiśle z lat pięćdziesiątych ma około czterystu metrów i przenosi około sześciu tysięcy pojazdów na dobę. Planowana jest obwodnica z nową przeprawą. Szczucin był też stacją końcową linii kolejowej z Tarnowa, otwartej w tysiąc dziewięćset szóstym roku — ruch pasażerski zawieszono w dwutysięcznym, a towarowy w dwa tysiące szóstym. Rewitalizacja tej linii jest zapowiedziana, ale to na razie plan.",
  ],
  districts: [
    "Szczucin — miasto",
    "Maniów i Radwan",
