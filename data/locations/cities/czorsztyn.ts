  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Jedna rzecz przetrwała w całości: drewniana kaplica cmentarna świętego Sebastiana z tysiąc siedemset dwudziestego trzeciego roku, postawiona jako wotum po epidemii czerwonki. Rozebrano ją i postawiono na nowym cmentarzu. Ostatni mieszkańcy starej wsi wyprowadzili się w tysiąc dziewięćset dziewięćdziesiątym piątym, a zbiornik zaczęto napełniać rok wcześniej.",
