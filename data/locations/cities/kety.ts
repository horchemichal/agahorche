...
export const KETY: CityContent = {
  ...
  seoDescription:
    "Thermomix w Kętach i całej gminie: bezpłatna prezentacja TM7 u Ciebie w kuchni, cena i raty 0%. Dojazd do wszystkich sołectw bez dopłat. Tel. 517 185 691.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "W tysiąc trzysta dziewięćdziesiątym roku urodził się tu Jan Kanty — profesor Akademii Krakowskiej, kanonizowany w tysiąc siedemset sześćdziesiątym siódmym. Pierwsza kaplica przy jego rodzinnym domu, jeszcze drewniana, stanęła w tysiąc sześćset czterdziestym ósmym roku, a ta murowana, którą się dziś ogląda — w tysiąc siedemset piętnastym. Pomnik stoi od tysiąc osiemset pięćdziesiątego pierwszego.",
      ],
    },
    {
      id: "jak-umowic",
  ...
  districtsParagraphs: [
    ...
    "W mieście warto zobaczyć rynek z ratuszem z tysiąc osiemsetnego roku, kościół świętej Małgorzaty i świętej Katarzyny przebudowany w tysiąc sześćset osiemdziesiątym piątym, klasztor Reformatów z początku osiemnastego wieku oraz kaplicę świętego Jana Kantego, wzniesioną w tysiąc siedemset piętnastym roku w miejscu drewnianej z tysiąc sześćset czterdziestego ósmego. Działa tu też muzeum imienia Aleksandra Kłosińskiego z około czterema tysiącami eksponatów.",
