  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Koniec przyszedł w tysiąc dziewięćset trzydziestym drugim roku i był całkiem prozaiczny: Krościenko straciło prawa miejskie, bo miało za mało mieszkańców. Ciekawy zbieg okoliczności — w tym samym roku, pierwszego czerwca, utworzono Pieniński Park Narodowy, najstarszy park narodowy w Polsce. Białowieski wydzielono dopiero dwa miesiące później.",
