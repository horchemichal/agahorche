  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Uczciwie o drugiej stronie: czasem naprawdę trzeba rozebrać więcej naraz. Przy remoncie, przy przeprowadzce, przy wymianie zabudowy nie ma jak zrobić tego po kawałku. Wtedy jedyne, co można zrobić, to policzyć z góry — kuchnia będzie niezdatna tygodniami, nie dniami. To nie jest powód, żeby nie zaczynać. To powód, żeby się nie zdziwić w środku.",
