...
export const IWANOWICE: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Ludzie mieszkają tu zresztą bardzo długo. Na Babiej Górze w Iwanowicach przebadano jedną z najlepiej rozpoznanych osad kultury mierzanowickiej z wczesnej epoki brązu, datowaną między dwa tysiące trzysta a tysiąc sześćset rokiem przed naszą erą. Ponad sto pięćdziesiąt grobów, badania prowadzone od tysiąc dziewięćset sześćdziesiątego siódmego roku wspólnie przez Polską Akademię Nauk i uniwersytet stanu Nowy Jork w Buffalo. Ze stanowiska pochodzi mniej więcej połowa wszystkiego, co o tej kulturze wiadomo.",
        "Parafię erygowano tu w tysiąc dwieście dziewięćdziesiątym trzecim roku, a w tysiąc trzysta czterdziestym drugim wieś przeniesiono z prawa polskiego na niemieckie.",
  ...
  culinary: {
    ...
    paragraphs: [
      ...
      "Ludzie uprawiają tu ziemię niewiarygodnie długo. Na Babiej Górze w Iwanowicach leży jedna z najlepiej przebadanych osad kultury mierzanowickiej, zamieszkana między dwa tysiące trzysta a tysiąc sześćset rokiem przed naszą erą — czyli przez blisko siedemset lat, na ośmiu hektarach nad doliną Dłubni. Ze stanowiska pochodzi około połowy wszystkiego, co o tej kulturze wiadomo.",
