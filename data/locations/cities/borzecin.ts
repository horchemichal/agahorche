...
export const BORZECIN: CityContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Borzęcin jest jedną z największych wsi w powiecie brzeskim — mieszka w nim ponad cztery tysiące osób — i jednocześnie jest podzielony na dwa sołectwa, Górny i Dolny. To nie są dwie osobne miejscowości, tylko jedna wieś z dwoma sołtysami, i warto to wiedzieć, zanim się zacznie szukać adresu.",
  ...
  districtsParagraphs: [
    ...
    "Gmina zajmuje sto trzy kilometry kwadratowe i liczy osiem tysięcy sto siedemnaście osób, czyli siedemdziesiąt dziewięć na kilometr kwadratowy. Sam Borzęcin, z ponad czterema tysiącami mieszkańców, należy do największych wsi w powiecie brzeskim — i jest jedną wsią podzieloną na dwa sołectwa. Jagniówka i Waryś funkcjonują zaś jednocześnie jako sołectwa i jako przysiółki, co bywa mylące.",
