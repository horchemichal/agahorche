  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Reszta historii gminy jest znacznie starsza i biskupia. Radłów pojawia się w dokumentach w latach osiemdziesiątych jedenastego wieku jako uposażenie biskupów krakowskich, a nazwę wziął od radła — narzędzia rolniczego. W tysiąc trzysta trzydziestym siódmym biskup Jan Grot postawił tu murowany kościół, który stoi do dziś — w tysiąc dziewięćset piętnastym poważnie uszkodził go ostrzał artyleryjski, a odbudowano go w latach dwudziestych. Proboszczem był tu w tysiąc pięćset trzydziestym trzecim Stanisław Hozjusz, późniejszy kardynał.",
